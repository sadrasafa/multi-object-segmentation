...
class FlowPairDetectron(Dataset):
    def __init__(self, data_dir, resolution, to_rgb=False, size_divisibility=None, enable_photo_aug=False, flow_clip=1., norm=True, read_big=False, force1080p=False, flow_res=None):
        self.eval = eval
        self.to_rgb = to_rgb
